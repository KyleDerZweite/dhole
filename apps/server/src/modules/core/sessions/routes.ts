...
import type { SessionMachines } from './service.js';
import {
...
export function configureSessionMachines(context: ServerContext, machines: SessionMachines): void { services.get(context)?.setMachines(machines); }
export function registerSessionRoutes(app: DholeApp, context: ServerContext): void {
